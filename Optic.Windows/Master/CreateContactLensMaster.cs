...
namespace Optic.Windows.Master
{
    public partial class CreateContactLensMaster : Form
    {
        ...
        public CreateContactLensMaster(OpticMasterDTO objMaster)
        {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(lblHiddenId.Text) || !manager.CheckMasterExists(txtName.Text, (int)MasterTypeEnum.ContactLensMaster))
            {
                ...
                opticMasterDto.MasterTypeID = (int)MasterTypeEnum.ContactLensMaster;
        ...
        private void CreateContactLensMaster_Load(object sender, EventArgs e)
        {
